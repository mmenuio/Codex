...
class SpansMetricsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    createSpansMetric(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SpansMetricsApi.createSpansMetric").makeRequestContext(localVarPath, http_1.HttpMethod.POST);
    ...
    deleteSpansMetric(metricId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SpansMetricsApi.deleteSpansMetric").makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
    ...
    getSpansMetric(metricId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = "/api/v2/apm/config/metrics/{metric_id}".replace("{metric_id}", encodeURIComponent(String(metricId)));
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SpansMetricsApi.getSpansMetric").makeRequestContext(localVarPath, http_1.HttpMethod.GET);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
    ...
    listSpansMetrics(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = "/api/v2/apm/config/metrics";
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SpansMetricsApi.listSpansMetrics").makeRequestContext(localVarPath, http_1.HttpMethod.GET);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
    ...
    updateSpansMetric(metricId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = "/api/v2/apm/config/metrics/{metric_id}".replace("{metric_id}", encodeURIComponent(String(metricId)));
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SpansMetricsApi.updateSpansMetric").makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Body Params
            const contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
