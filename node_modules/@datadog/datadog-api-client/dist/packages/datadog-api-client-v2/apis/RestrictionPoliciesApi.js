...
class RestrictionPoliciesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    deleteRestrictionPolicy(resourceId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestContext = (0, configuration_1.getServer)(_config, "v2.RestrictionPoliciesApi.deleteRestrictionPolicy").makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
    ...
    getRestrictionPolicy(resourceId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = "/api/v2/restriction_policy/{resource_id}".replace("{resource_id}", encodeURIComponent(String(resourceId)));
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.RestrictionPoliciesApi.getRestrictionPolicy").makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    updateRestrictionPolicy(resourceId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = "/api/v2/restriction_policy/{resource_id}".replace("{resource_id}", encodeURIComponent(String(resourceId)));
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.RestrictionPoliciesApi.updateRestrictionPolicy").makeRequestContext(localVarPath, http_1.HttpMethod.POST);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Body Params
