...
describe('v2beta2.CloudTasksClient', () => {
    ...
    describe('bufferTask', () => {
        it('invokes bufferTask without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.BufferTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.BufferTaskRequest', ['queue']);
            request.queue = defaultValue1;
            const defaultValue2 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.BufferTaskRequest', ['taskId']);
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.BufferTaskResponse());
