...
var CloudTasksClient = exports.CloudTasksClient = /*#__PURE__*/function () {
  ...
  _createClass(CloudTasksClient, [{
    ...
    value: function initialize() {
      ...
      var cloudTasksStubMethods = ['listQueues', 'getQueue', 'createQueue', 'updateQueue', 'deleteQueue', 'purgeQueue', 'pauseQueue', 'resumeQueue', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions', 'listTasks', 'getTask', 'createTask', 'deleteTask', 'runTask', 'bufferTask'];
