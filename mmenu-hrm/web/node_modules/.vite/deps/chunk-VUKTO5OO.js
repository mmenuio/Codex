  ...
  "node_modules/grpc-web/index.js"(exports, module) {
    ...
    function zb(a, b, c, d, f) {
      if (d && d.once)
        ...
        c = Bb(c), a && a[M] ? a.f.add(String(b), c, false, sa(d) ? !!d.capture : !!d, f) : Cb(a, b, c, false, d, f);
    }
    function Cb(a, b, c, d, f, g) {
      ...
      if (!c.proxy) {
        ...
        if (a.addEventListener)
          ob || (f = e), void 0 === f && (f = false), a.addEventListener(b.toString(), d, f);
    ...
    function Ab(a, b, c, d, f) {
      if (Array.isArray(b))
        ...
        c = Bb(c), a && a[M] ? a.f.add(String(b), c, true, sa(d) ? !!d.capture : !!d, f) : Cb(a, b, c, true, d, f);
    }
    ...
    function X(a) {
      ...
      zb(this.a, "complete", function() {
        ...
        if (0 != c) {
          ...
          c = false, "grpc-status" in e && (d = Number(e["grpc-status"]), "grpc-message" in e && (f = e["grpc-message"]), 0 != d && (Y(b, new E(d, f || "", e)), c = true)), c || Lc(b);
      });
    }
...
//# sourceMappingURL=chunk-VUKTO5OO.js.map
