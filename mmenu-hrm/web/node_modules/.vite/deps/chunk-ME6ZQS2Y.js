import {
  ...
  reflow
} from "./chunk-OKBK7535.js";
import {
  ButtonBase_default,
  Transition_default
} from "./chunk-VJVQYH2G.js";
import {
  useTheme
} from "./chunk-EBGMZZOM.js";
import {
  alpha,
  useRtl
} from "./chunk-MAB5YIRF.js";
import {
  createSvgIcon,
  init_createSvgIcon,
  init_isMuiElement,
...
} from "./chunk-P4I3EW7A.js";
import {
  css,
  keyframes
} from "./chunk-43K66GBC.js";
import {
  _extends,
  init_extends
...
var Rating = React24.forwardRef(function Rating2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiRating",
    props: inProps
  });
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React24.useState(false);
  const ownerState = _extends({}, props, {
    defaultValue,
    disabled,
    emptyIcon,
...
var SpeedDial = React27.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded18), other = _objectWithoutPropertiesLoose(props, _excluded24);
  ...
  return (0, import_jsx_runtime32.jsxs)(SpeedDialRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    ...
    children: [(0, import_jsx_runtime31.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime31.jsx)(SpeedDialFab, _extends({
        color: "primary",
...
true ? SpeedDial.propTypes = {
   ...
   */
  ariaLabel: import_prop_types14.default.string.isRequired,
  /**
   ...
   * @default {}
   */
  FabProps: import_prop_types14.default.object,
  /**
...
var Tooltip = React28.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React28.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime33.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime34.jsxs)(React28.Fragment, {
    children: [React28.cloneElement(children, childrenProps), (0, import_jsx_runtime33.jsx)(PopperComponent, _extends({
...
var SpeedDialAction = React29.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const fab = (0, import_jsx_runtime35.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime36.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
  ...
  return (0, import_jsx_runtime35.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
true ? SpeedDialAction.propTypes = {
   ...
   * @default 0
   */
  delay: import_prop_types16.default.number,
  /**
   ...
   */
  TooltipClasses: import_prop_types16.default.object,
  /**
   * Make the tooltip always visible when the SpeedDial is open.
   * @default false
   */
  tooltipOpen: import_prop_types16.default.bool,
  /**
   * Placement of the tooltip.
   * @default 'left'
   */
  tooltipPlacement: import_prop_types16.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
   * Label to display in the tooltip.
   */
  tooltipTitle: import_prop_types16.default.node
} : void 0;
...
var Add_default = createSvgIcon((0, import_jsx_runtime37.jsx)("path", {
...
var SpeedDialIcon = React31.forwardRef(function SpeedDialIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime39.jsxs)(SpeedDialIconRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    ownerState
  }, other, {
    children: [openIconProp ? formatIcon(openIconProp, classes.openIcon) : null, iconProp ? formatIcon(iconProp, classes.icon) : (0, import_jsx_runtime38.jsx)(Add_default, {
      className: classes.icon
    })]
  }));
});
true ? SpeedDialIcon.propTypes = {
   ...
   */
  openIcon: import_prop_types17.default.node,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var ToggleButton = React34.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React34.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded25);
  ...
  return (0, import_jsx_runtime40.jsx)(ToggleButtonRoot, _extends({
...
var ToggleButtonGroup = React35.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsx)(ToggleButtonGroupRoot, _extends({
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
    ownerState
  }, other, {
    children: (0, import_jsx_runtime41.jsx)(ToggleButtonGroupContext_default.Provider, {
      value: context,
      children: validChildren.map((child, index) => {
        if (true) {
        ...
        return (0, import_jsx_runtime41.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
          value: getButtonPositionClassName(index),
          children: child
        }, index);
      })
...
//# sourceMappingURL=chunk-ME6ZQS2Y.js.map
