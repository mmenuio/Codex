...
export declare class LogsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    listLogsGet(filterQuery?: string, filterIndex?: string, filterFrom?: Date, filterTo?: Date, filterStorageTier?: LogsStorageTier, sort?: LogsSort, pageCursor?: string, pageLimit?: number, _options?: Configuration): Promise<RequestContext>;
