...
class SyntheticsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getOnDemandConcurrencyCap(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SyntheticsApi.getOnDemandConcurrencyCap").makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    setOnDemandConcurrencyCap(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = "/api/v2/synthetics/settings/on_demand_concurrency_cap";
            // Make Request Context
            const requestContext = (0, configuration_1.getServer)(_config, "v2.SyntheticsApi.setOnDemandConcurrencyCap").makeRequestContext(localVarPath, http_1.HttpMethod.POST);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Body Params
