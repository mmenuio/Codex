...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // Copyright 2023 Google LLC
//
 ...
 */
var gapicConfig = JSON.parse(_fs["default"].readFileSync(_path["default"].join(dirname, 'cloud_tasks_client_config.json'), 'utf8'));
var jsonProtos = JSON.parse(_fs["default"].readFileSync(_path["default"].join(dirname, '..', '..', '..', 'protos/protos.json'), 'utf8'));
var version = JSON.parse(_fs["default"].readFileSync(_path["default"].join(dirname, '..', '..', '..', '..', 'package.json'), 'utf8')).version;
...
var CloudTasksClient = exports.CloudTasksClient = /*#__PURE__*/function () {
  ...
  function CloudTasksClient(opts, gaxInstance) {
    var _opts, _opts2, _opts3, _opts4, _opts5, _opts$clientConfig, _opts6, _opts$fallback, _opts7, _window;
    ...
    var servicePath = ((_opts = opts) === null || _opts === void 0 ? void 0 : _opts.servicePath) || ((_opts2 = opts) === null || _opts2 === void 0 ? void 0 : _opts2.apiEndpoint) || staticMembers.servicePath;
    this._providedCustomServicePath = !!((_opts3 = opts) !== null && _opts3 !== void 0 && _opts3.servicePath || (_opts4 = opts) !== null && _opts4 !== void 0 && _opts4.apiEndpoint);
    var port = ((_opts5 = opts) === null || _opts5 === void 0 ? void 0 : _opts5.port) || staticMembers.port;
    var clientConfig = (_opts$clientConfig = (_opts6 = opts) === null || _opts6 === void 0 ? void 0 : _opts6.clientConfig) !== null && _opts$clientConfig !== void 0 ? _opts$clientConfig : {};
    var fallback = (_opts$fallback = (_opts7 = opts) === null || _opts7 === void 0 ? void 0 : _opts7.fallback) !== null && _opts$fallback !== void 0 ? _opts$fallback : typeof window !== 'undefined' && typeof ((_window = window) === null || _window === void 0 ? void 0 : _window.fetch) === 'function';
    opts = Object.assign({
    ...
    if (opts.libVersion && isEsm) {
      clientHeader.push("".concat(opts.libVersion, "-esm"));
    } else if (opts.libVersion && !isEsm) {
      clientHeader.push("".concat(opts.libVersion, "-cjs"));
    }
  ...
  _createClass(CloudTasksClient, [{
    ...
    value: function initialize() {
      ...
      var cloudTasksStubMethods = ['listQueues', 'getQueue', 'createQueue', 'updateQueue', 'deleteQueue', 'purgeQueue', 'pauseQueue', 'resumeQueue', 'uploadQueueYaml', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions', 'listTasks', 'getTask', 'createTask', 'deleteTask', 'leaseTasks', 'acknowledgeTask', 'renewLease', 'cancelLease', 'runTask', 'bufferTask'];
    ...
    key: "bufferTask",
    value: function bufferTask(request, optionsOrCallback, callback) {
      var _request$queue, _request$taskId;
      request = request || {};
      var options;
      if (typeof optionsOrCallback === 'function' && callback === undefined) {
        callback = optionsOrCallback;
      ...
      options.otherArgs.headers = options.otherArgs.headers || {};
      options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
        queue: (_request$queue = request.queue) !== null && _request$queue !== void 0 ? _request$queue : '',
        task_id: (_request$taskId = request.taskId) !== null && _request$taskId !== void 0 ? _request$taskId : ''
      });
      this.initialize();
