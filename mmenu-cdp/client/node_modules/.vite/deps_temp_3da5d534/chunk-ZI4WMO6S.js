...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(NotchedOutlineRoot, _extends({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
    children: (0, import_jsx_runtime4.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime4.jsx)("span", {
        children: label
      }) : (
...
var OutlinedInput = React5.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime6.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime5.jsxs)(React5.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
//# sourceMappingURL=chunk-ZI4WMO6S.js.map
